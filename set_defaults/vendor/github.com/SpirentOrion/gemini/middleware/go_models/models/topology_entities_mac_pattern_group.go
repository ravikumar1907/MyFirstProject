...
// TopologyEntitiesMacPatternGroup topology entities mac pattern group
//
// swagger:model topology.entities.MacPatternGroup
type TopologyEntitiesMacPatternGroup struct {
...
// Validate validates this topology entities mac pattern group
func (m *TopologyEntitiesMacPatternGroup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopologyEntitiesMacPatternGroup) validateCounter(formats strfmt.Registry) error {
...
func (m *TopologyEntitiesMacPatternGroup) validatePatternType(formats strfmt.Registry) error {
...
// ContextValidate validate this topology entities mac pattern group based on the context it is used
func (m *TopologyEntitiesMacPatternGroup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopologyEntitiesMacPatternGroup) contextValidateCounter(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopologyEntitiesMacPatternGroup) contextValidatePatternType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopologyEntitiesMacPatternGroup) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TopologyEntitiesMacPatternGroup) UnmarshalBinary(b []byte) error {
	var res TopologyEntitiesMacPatternGroup
