...
// TopologyEntitiesIPV6PatternGroup topology entities Ipv6 pattern group
//
// swagger:model topology.entities.Ipv6PatternGroup
type TopologyEntitiesIPV6PatternGroup struct {
...
// Validate validates this topology entities Ipv6 pattern group
func (m *TopologyEntitiesIPV6PatternGroup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TopologyEntitiesIPV6PatternGroup) validateCounter(formats strfmt.Registry) error {
...
func (m *TopologyEntitiesIPV6PatternGroup) validatePatternType(formats strfmt.Registry) error {
...
// ContextValidate validate this topology entities Ipv6 pattern group based on the context it is used
func (m *TopologyEntitiesIPV6PatternGroup) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *TopologyEntitiesIPV6PatternGroup) contextValidateCounter(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopologyEntitiesIPV6PatternGroup) contextValidatePatternType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TopologyEntitiesIPV6PatternGroup) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TopologyEntitiesIPV6PatternGroup) UnmarshalBinary(b []byte) error {
	var res TopologyEntitiesIPV6PatternGroup
